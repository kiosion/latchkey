...
- Tag composes a 125 kHz ID. All three renderings show at once and up/down
  ...
  split is usually what is printed on the tag.
...
- Console sends an arbitrary payload. Length, sequence and checksum are
  added automatically; a bad reply checksum is flagged.
